...
-- Idempotent migration for databases created before owner linkage was added.
ALTER TABLE app_user ADD COLUMN IF NOT EXISTS owner_id VARCHAR(32);
...
ALTER TABLE dispatch_task ADD COLUMN IF NOT EXISTS status VARCHAR(16) NOT NULL DEFAULT 'QUEUED';
ALTER TABLE dispatch_task ADD COLUMN IF NOT EXISTS progress INT NOT NULL DEFAULT 0;
ALTER TABLE dispatch_task ADD COLUMN IF NOT EXISTS slot_id VARCHAR(16);
ALTER TABLE dispatch_task ADD COLUMN IF NOT EXISTS agv_id VARCHAR(16);
ALTER TABLE dispatch_task ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
